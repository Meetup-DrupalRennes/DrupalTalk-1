...
/**
 * Provides a well cached block.
 *
 * @Block(
 *  id = "well_cached_block",
 *  admin_label = @Translation("Bloc avec cache bien réglé"),
 * )
 */
class WellCachedBlock extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  private function getLatestPost() {
    ...
    $posts = $storage->getQuery()->condition('uid', $this->currentUser->id())->execute();
  ...
  public function getCacheTags() {
    return array_merge(['node_list', 'user:' . $this->currentUser->id()], parent::getCacheTags());
  }
  ...
  public function getCacheContexts() {
    return array_merge(['user'], parent::getCacheContexts());
  }
